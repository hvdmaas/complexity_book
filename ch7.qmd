...
![Bottom-up voting in hierarchical systems in the Galam model.](media/ch7/image5.jpg){#fig-ch7-img5-old-93 width="12cm"}
...
![Convergence of opinion in the Friedkin—Johnson model in a connected network of agents.](media/ch7/fig-ch7-img7-old-95.png){#fig-ch7-img7-old-95 width="12cm"}
...
![Four example runs of the Deffuant model with four different boundaries. Lower bounds of confidence lead to polarization.](media/ch7/fig-ch7-img8-old-96.png){#fig-ch7-img8-old-96 width="13cm"}
...
![Clustering in the Hegselmann—Krause model.](media/ch7/fig-ch7-img9-old-97.png){#fig-ch7-img9-old-97 width="12cm"}
