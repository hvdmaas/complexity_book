...
![The order parameter, the total number of unique words, undergoes a phase transition to a state where everyone uses the same word for the object (compare Castellano et al., 2009, fig.2).](media/ch7/fig-ch7-img3-old-91.png){#fig-ch7-img3-old-91 width="80%"}
...
![Convergence of opinion in the Friedkin—Johnson model in a connected network of agents.](media/ch7/fig-ch7-img7-old-95.png){#fig-ch7-img7-old-95 width="80%"}
