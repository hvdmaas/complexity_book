...
![BehaviorSpace settings and R code to visualize the effects of intolerance on segregation.](media/ch7/image1.jpg){#fig-ch7-img1-old-89 width="13cm"}
...
![The naming game. The speaker chooses the highlighted word. If the listener does not know the word (failure), she adds it to her inventory. In case of success, both agents delete their inventories, keeping only the spoken word. (Adapted from Castellano et al., 2009)](media/ch7/ch7-2-may31.png){#fig-ch7-img2-old-90}
...
![The order parameter, the total number of unique words, undergoes a phase transition to a state where everyone uses the same word for the object (compare Castellano et al., 2009, fig.2).](media/ch7/fig-ch7-img3-old-91.png){#fig-ch7-img3-old-91 width="12cm"}
...
![Two runs of Axelrod's model. For four features with four possible values, only one culture remains. For the second case ($F = 2, Q = 10$), multiple unique cultures, different in all features, emerge.](media/ch7/fig-ch7-img4-old-92.png){#fig-ch7-img4-old-92 width="12cm"}
...
![Bottom-up voting in hierarchical systems in the Galam model.](media/ch7/ch7-5__figure95.png){#fig-ch7-img5-old-93}
...
![Convergence of opinion in the Friedkin—Johnson model in a connected network of agents.](media/ch7/fig-ch7-img7-old-95.png){#fig-ch7-img7-old-95 width="14cm"}
...
![Four example runs of the Deffuant model with four different boundaries. Lower bounds of confidence lead to polarization.](media/ch7/fig-ch7-img8-old-96.png){#fig-ch7-img8-old-96 width="14cm"}
...
![Clustering in the Hegselmann—Krause model.](media/ch7/fig-ch7-img9-old-97.png){#fig-ch7-img9-old-97 width="14cm"}
