...
Another great tool in R is the deBif package by de Roos.[^ch4n-4] This is a R Shiny application that uses the same model specification and allows for a more interactive investigation. Given our previous model and the definition of $s$ and $p$, we can run:
