...
5)  Use the spruce model from Section 5.1.6 and the `bifurcation()` function of the deBif package to recreate the bifurcation diagram shown in @fig-ch3-img16-old-28 . Describe what you did and present the resulting figure. (\*\*)
