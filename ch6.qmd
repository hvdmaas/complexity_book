...
![The number of papers in Google Scholar on the combination of symptoms and "network analysis" grows exponentially.](media/ch6/fig-ch6-img1-old-70.jpg){#fig-ch6-img1-old-70 width="90%"}
...
![A weighted directed network with self-loops. Red arrows indicate negative effects. OutStrength and InStrength represent two types of centrality measures in directed networks.](media/ch6/fig-ch6-img2-old-71.png){#fig-ch6-img2-old-71 width="100%"}
...
![Different network types generated with igraph.](media/ch6/fig-ch6-img3-old-72.png){#fig-ch6-img3-old-72 width="100%"}
...
![The mutualism model. The self-loops have an excitatory ($aX$) and an inhibitory part ($- aX^{2}K$).](media/ch6/fig-ch6-img6-old-75.png){#fig-ch6-img6-old-75 width="100%"}
...
![A typical run of the mutualism model for one subject and the distribution of correlations between $X$-values across subjects.](media/ch6/fig-ch6-img7-old-76.jpg){#fig-ch6-img7-old-76 width="100%"}
...
![The Ising attitude network model. Feelings, beliefs, and behaviors toward an attitude object align when attended to. Nodes are also influenced by local and global external fields. The connections are weighted.](media/ch6/ch6-12.png){#fig-attitudenetwork width="80%"}
...
![The mean field approximation of the Ising attitude model is the cusp. Attention is the psychological equivalent of inverse temperature.](media/ch6/ch6-13.png){#fig-ch6-img11-old-80 width="80%"}
...
![The block structure in the mutualism model can be represented as either a network or a factor model.](media/ch6/image17.jpg){#fig-ch6-img17-old-86 width="100%"}
...
![The attitude toward Obama in 2012 represented as a network.](media/ch6/fig-ch6-img19-old-88.png){#fig-ch6-img19-old-88 width="100%"}
