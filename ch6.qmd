...
![The small world of psychopathology. Symptoms are represented as nodes and connected by an edge whenever they figure in the same disorder. (Adapted from @borsboomSmallWorldPsychopathology2011 with permission)](media/ch6/image8.jpg){#fig-ch6-img8-old-77 width="20cm"}
...
![The butterfly catastrophe associated with the tricritical Ising model. The potential function can have three minima. In the figure $a = c = 0, d = 5, b$ varies from $1$ to $-7$.](media/ch6/image15.jpg){#fig-ch6-img15-old-84}
...
![The attitude toward Obama in 2012 represented as a network.](media/ch6/fig-ch6-img19-old-88.png){#fig-ch6-img19-old-88 width="14cm"}
