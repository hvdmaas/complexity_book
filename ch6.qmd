...
![The mutualism model. The self-loops have an excitatory ($aX$) and an inhibitory part ($- aX^{2}K$).](media/ch6/fig-ch6-img6-old-75.png){#fig-ch6-img6-old-75 width="18cm"}
...
W <- W * matrix(sample(0:1,n^2,prob=c(.8,.2),
                       replace=T),n,n) # delete 80% of nodes
