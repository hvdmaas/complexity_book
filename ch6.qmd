...
![Different network types generated with Igraph.](media/ch6/fig-ch6-img3-old-72.jpg){#fig-ch6-img3-old-72}
...
In this case we want to update the nodes values using the Glauber dynamics (@eq-ch4-3), which uses the computation of the energy of a particular state. Both functions (glauber_step and hamiltonian) are added to the R-code.
...
You can compare this to @eq-ch4-1. The last term penalizes (increases the energy) of the -1 and +1 states relative to the 0 state.
