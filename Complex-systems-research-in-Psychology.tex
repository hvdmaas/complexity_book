...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[breakable, boxrule=0pt, enhanced, frame hidden, sharp corners, colback={codebgcolor}]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
