...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[frame hidden, colback={codebgcolor}, enhanced, boxrule=0pt, sharp corners, breakable]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
...
self-organization would not be possible. Self-organization takes energy.
The emergent patterns in a complex system may be stable for some time,
but often change suddenly. The study of phase transitions or tipping
points is therefore central to the study of complex systems. They may
also exhibit chaotic behavior, implying that they can be fundamentally
...
\includegraphics{media/ch1/ch1-1-june14.jpg}

}

\caption{\label{fig-ch1-img1}A flock of birds is an example of a complex
system in which global patterns emerge naturally from simple rules and
local interactions.}
...
The first question is why it is possible to conduct scientific research
in fields other than physics, given that ultimately, chemistry, biology,
and even psychology are fundamentally concerned with interactions among
elementary particles. Should we not first finish the study of physics
before starting to think about complex molecules, cells, neurons, or
higher-order human cognition?

Philip Anderson's renowned paper ``More Is Different'' convincingly
argues that the answer to this question is a resounding \emph{no}
...
\includegraphics{media/ch1/ch1-2-june14.png}
...
human brain, arguably the most complex system we know, is embedded in
different hierarchies of very complex social systems such as families,
education, economies, and cultures. We need the toolbox!
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch1/ch1-3.png}
...
I will discuss three specific reasons to be somewhat optimistic, based
on three key observations about complex systems. The first key
observation has to do with simplification, the second with the tendency
of complex systems to be characterized by a limited number of stable
states, and the third is that all complex systems seem to be describable
as some kind of network. Simplification is perhaps the most important
one.
...
type of simulation proves very useful for designing and optimizing
highways and roads (Barceló 2010; Treiber, Hennecke, and Helbing 2000).
There are actually different ways to model traffic jams. Jusup et al.
(2022) distinguish between fluid-dynamical, kinetic, car-following,
coupled-map lattice, and cellular automata models. They all reproduce
many phenomena of real traffic jams.
...
to global behavior. A large part of the art of science is finding the
...
as gradual.\end{footnotesize}}} But at least some complex psychological
systems are clearly stable over the long term. Unfortunately, this is
true of many psychological disorders. In contrast, my understanding of
the world, psychological science, and complex-systems research is better
described as a continuously perturbed non-equilibrium system with just
enough stability to write this book (once).
...
tornado in Iowa.\end{footnotesize}}}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch2/fig-ch2-img1.jpg}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch2/fig-ch2-img2.jpg}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch2/fig-ch2-img3.jpg}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch2/fig-ch2-img4.jpg}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch2/fig-ch2-img5.jpg}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch2/fig-ch2-img6.jpg}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch2/fig-ch2-img7.jpg}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch2/fig-ch2-img8.jpg}
...
Let's review the concepts we have already learned. The first is the
concept of equilibrium. The states of dynamical systems tend to converge
to certain values. The simplest of these is the fixed point. Fixed
points can be stable or unstable (more on this in the next chapter). If
we start a system exactly at its unstable fixed point (and there is no
noise in the system), it will stay there. But any small perturbation
will cause it to escape and move to the fixed stable point.
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch3/ch3-1-may31.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch3/ch3-02__figure14.png}
...
{\marginnote{\begin{footnotesize}In gradient systems some quantity, such
as energy, is minimized or maximized.\end{footnotesize}}} Catastrophe
theory is concerned with gradient systems. These are dynamic systems
that can be described by a potential function. Potential functions can
be thought of as landscapes with minima and maxima in which we throw a
ball and see where it ends up. The simplest case, discussed in the next
section, is the quadratic minimum. {\marginnote{\begin{footnotesize}A
potential function in mathematics describes the potential energy
landscape of a system, where the system's dynamics are determined by the
gradients of this function.\end{footnotesize}}} We can also study what
happens to the ball if the landscape changes shape smoothly and a
minimum disappears. Then sudden jumps can occur.
...
\includegraphics[width=0.4\textwidth,height=\textheight]{media/ch3/ch3-3-may31.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch3/fig-ch3-img4-old-16.png}
...
\(a\), from \(0\) to \(2\). On the y-axis we plot \(X^{*}\), the fixed
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch3/fig-ch3-img5-old-17.png}
...
\includegraphics[width=0.9\textwidth,height=\textheight]{media/ch3/ch3-6__figure18.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch3/ch3-7__figure19.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch3/ch3-8__figure20.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch3/ch3-9.png}
...
\includegraphics[width=0.6\textwidth,height=\textheight]{media/ch3/ch3-10-june14.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch3/ch3-11-may31.png}
...
\includegraphics[width=0.6\textwidth,height=\textheight]{media/ch3/ch3-12-may31.png}
...
\includegraphics[width=0.6\textwidth,height=\textheight]{media/ch3/ch3-13-june14.png}
...
neutral.\end{footnotesize}}} Ambivalence is associated with high
...
\includegraphics[width=0.9\textwidth,height=\textheight]{media/ch3/image14.jpg}
...
\includegraphics[width=0.9\textwidth,height=\textheight]{media/ch3/ch3-15-may31.png}
...
\includegraphics[width=0.6\textwidth,height=\textheight]{media/ch3/ch3-16-may31.png}
...
whether the pitchfork bifurcation makes sense theoretically.\footnote{Given
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch3/ch3-17-june14.png}
...
(2008) in his fascinating book on mathematics and humor. Paulos explains
his model in the context of puns. His example is: ``Do you consider
clubs appropriate for young children?'' with the punchline ``Only when
kindness fails,'' which is probably only funny to people with children.
Paulos uses the rotated control axis as in the dog aggression model.
Interpretation of the pun is the behavioral axis. One axis represents
the first meaning of ``clubs,'' the other axis represents the second
meaning. The bifurcation set represents the ambiguous region. A joke
involves a jump from one meaning to another.
...
unstable.\end{footnotesize}}} But then what is the difference with an
continuous acceleration, such as we see in a logistic growth pattern?
The time course of an acceleration and a sudden, discontinuous jump may
look very similar (figure~\ref{fig-ch3-img18-old-30}).

\begin{figure}

\centering{

\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch3/ch3-18-may31.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch3/fig-ch3-img19-old-31.png}
...
\NormalTok{x }\OtherTok{\textless{}{-}} \FunctionTok{read.table}\NormalTok{(}\StringTok{\textquotesingle{}data/PNAS\_patient\_data.txt\textquotesingle{}}\NormalTok{, }\AttributeTok{header =} \ConstantTok{TRUE}\NormalTok{)}
...
\includegraphics[width=0.9\textwidth,height=\textheight]{media/ch3/ch3-20.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch3/ch3-21-may31.png}
...
increase and decrease the normal variable and test whether sudden jumps
...
and van der Maas 2001). We also hypothesized that speeding up subjects
...
\includegraphics[width=0.9\textwidth,height=\textheight]{media/ch3/ch3-22-june14.png}
...
variance \(\sigma^{2})\), to equation~\ref{eq-ch3-2-old-6}\footnote{Many
  ...
  \(dX(t) = - V^{'}\left( X(t) \right)dt + \sigma dW(t)\), as both
  \(dX\) and \(dW\) depend on time.}:
...
\caption{The comparative fit measures AIC, AICc, and BIC indicate that
the reduced model should be the model of
choice.}\label{tbl-comparative-fit}\tabularnewline
\end{longtable}
...
\NormalTok{X1 }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(}\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{, }\AttributeTok{le =}\NormalTok{ n) }\CommentTok{\# independent variable 1}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch3/fig-ch3-img23-old-35.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch3/ch3-24__figure36.png}
...
\includegraphics{media/ch3/fig-ch3-img25-old-37.png}
...
\includegraphics[width=0.5\textwidth,height=\textheight]{media/ch3/ch3-26-june14.png}
...
are sufficient to apply the cusp fit function in R.}
...
in our work, I will briefly respond to Zahler and Sussmann's main points
of criticism. In their introduction, they state that there may be
...
and inconsistent with the data (which could be true), while also not
falsifiable. But you cannot have it both ways: if it is wrong or
inconsistent with the data, it is falsifiable. Nevertheless, I agree
that it is important to think about falsifiability. Theories in
psychology tend to be moving targets. As soon as someone finds an
empirical result that contradicts the theory, the theory is quickly
modified.
...
\section{Introduction}\label{sec-Introduction-ch4n}
...
Lotka---Volterra models describe the dynamics of biological systems in
...
predators increase as a function of both \(N\) and \(P\), as they eat
...
\NormalTok{data }\OtherTok{\textless{}{-}} \FunctionTok{run}\NormalTok{(}\AttributeTok{odes =}\NormalTok{ LV, }\AttributeTok{tstep =}\NormalTok{ .}\DecValTok{01}\NormalTok{, }\AttributeTok{table =} \ConstantTok{TRUE}\NormalTok{) }\CommentTok{\# set tstep to low value}
\CommentTok{\# phase plot for different starting values:}
\FunctionTok{plane}\NormalTok{(}\AttributeTok{odes =}\NormalTok{ LV, }\AttributeTok{portrait =} \ConstantTok{TRUE}\NormalTok{,}
      \AttributeTok{ymax =} \DecValTok{17}\NormalTok{, }\AttributeTok{xmax =} \DecValTok{50}\NormalTok{, }\AttributeTok{tstep =} \FloatTok{0.1}\NormalTok{, }\AttributeTok{grid =} \DecValTok{4}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{p }\OtherTok{\textless{}{-}}\NormalTok{ p }\SpecialCharTok{*} \FunctionTok{abs}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(}\DecValTok{4}\NormalTok{, }\DecValTok{1}\NormalTok{, }\FloatTok{0.1}\NormalTok{)); p }\CommentTok{\# start values}
...
\NormalTok{pars }\OtherTok{\textless{}{-}} \FunctionTok{rbind}\NormalTok{(pars, }\FunctionTok{c}\NormalTok{(}\FunctionTok{summary}\NormalTok{(f\_deter)}\SpecialCharTok{$}\NormalTok{sigma, }\FunctionTok{summary}\NormalTok{(f\_stoch)}\SpecialCharTok{$}\NormalTok{sigma,}
                      \FunctionTok{summary}\NormalTok{(f\_error)}\SpecialCharTok{$}\NormalTok{sigma))}
\FunctionTok{barplot}\NormalTok{(}\FunctionTok{t}\NormalTok{(pars), }\AttributeTok{beside =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{names =} \FunctionTok{c}\NormalTok{(}\StringTok{\textquotesingle{}a\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}c\textquotesingle{}}\NormalTok{,}\StringTok{\textquotesingle{}d\textquotesingle{}}\NormalTok{, }\StringTok{\textquotesingle{}Residuals\textquotesingle{}}\NormalTok{),}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch4n/fig-ch4n-img1-old-49.png}
...
\NormalTok{data }\OtherTok{\textless{}{-}} \FunctionTok{run}\NormalTok{(}\AttributeTok{table =} \ConstantTok{TRUE}\NormalTok{, }\AttributeTok{tmax =} \DecValTok{1000}\NormalTok{, }\AttributeTok{method =} \StringTok{\textquotesingle{}euler\textquotesingle{}}\NormalTok{, }\AttributeTok{tstep =}\NormalTok{ .}\DecValTok{1}\NormalTok{, }
            \AttributeTok{after =} \StringTok{"state \textless{}{-} state + rnorm(1,mean=0,sd=0.4) * sqrt(tstep)"}\NormalTok{, }
            \AttributeTok{ymax =} \DecValTok{2}\NormalTok{, }\AttributeTok{ymin =} \SpecialCharTok{{-}}\DecValTok{2}\NormalTok{, }\AttributeTok{timeplot =} \ConstantTok{FALSE}\NormalTok{)}
...
\FunctionTok{barplot}\NormalTok{(}\FunctionTok{hist}\NormalTok{(data[,}\DecValTok{2}\NormalTok{], }\DecValTok{30}\NormalTok{, }\AttributeTok{plot =}\NormalTok{ F)}\SpecialCharTok{$}\NormalTok{counts, }\AttributeTok{xlab =} \StringTok{"X"}\NormalTok{, }\AttributeTok{hor =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch4n/fig-ch4n-img2-old-50.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch4n/ch4-3-june14.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch4n/ch4n-4-june24.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch4n/ch4-5-may31.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch4n/fig-ch4n-img6-old-54.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch4n/fig-ch4n-img7-old-55.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch4n/ch4n-8__figure57.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch4n/fig-ch4n-img9-old-57.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch4n/fig-ch4n-img10-old-58.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch4n/fig-ch4n-img11-old-59.png}
...
\includegraphics[width=0.6\textwidth,height=\textheight]{media/ch4n/fig-ch4n-img12-old-60_above.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch4n/fig-ch4n-img13-old-61.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch4n/fig-ch4n-img14-old-62.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch4n/ch4-15-may31.png}
...
network might increase \(K\) (availability). These modeling issues are
serious but also very interesting (Dongen et al. 2024).
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch4n/fig-ch4n-img16-old-64_above.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch4n/fig-ch4n-img17-old-65.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch4n/image18.jpg}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch4n/fig-ch4n-img19-old-67.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch4n/ch4n-20__figure69.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch4n/ch4-21-june14.png}
...
in cooperation and opinion polarization.
...
this global behavior, chaos, bifurcation, and dynamical systems theory
...
locations on a two-dimensional grid. Atoms have left (\(-1\)) or right
(\(1\)) spins. When the spins are aligned (all \(1\) or all \(-1\)), we
...
the magnet: the temperature of the magnet and the external magnetic
field. The lower the temperature, the more the spins align.
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch5n/ch5-1-june14.png}

}

\caption{\label{fig-ch5n-img1-old-39}Schematic picture of the magnet.
Spins, \(x\), can be left (\(-1\)) or right (\(1\)). At lower
temperatures, \(T\), the spins tend to align with neighboring spins and
the external field, \(\tau\), resulting in magnetism.}
...
spins to be all left or all right.\end{footnotesize}}} The external
field and temperature are \(\tau\) and \(T\) (\(1/\beta\)),
...
spins (right column of figure~\ref{fig-ch5n-img1-old-39}) and no
external field, then we have \(\mathbf{x} = (1,1,1,1)\) and \(H = - 6\).
This is also the case for \(\mathbf{x} = ( - 1, - 1, - 1, - 1)\), but
any other state has a higher energy.

The second equation defines the probability of a certain state (e.g.,
all spins \(1\)). This probability requires a normalization, \(Z\), to
...
the spins begin to align and soon are all \(1\) or \(-1\). This is the
...
or randomness.\end{footnotesize}}} One way of stating the second law is
that heat flows spontaneously from hot objects to cold objects, and not
the other way around, unless external work is applied to the system. A
more appealing example might be the student room that never naturally
...
later using NetLogo, is that rotating global spirals emerge that isolate
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch5n/ch5-2-june14.jpg}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch5n/ch5n-3.png}
...
example, the line-puffer superstable or one of the spaceship types. My
favorite is the metapixel galaxy in the HashLife folder. Note that you
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch5n/image4.jpg}

}

\caption{\label{fig-ch5n-img4-old-42}The Turing machine built in the
Game of Life. (Reproduced from LifeWiki.)}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch5n/ch5n-5__figure43.png}
...
\includegraphics[width=0.6\textwidth,height=\textheight]{media/ch5n/ch5n-6.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch5n/image7.jpg}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch5n/strandbeest_Han_perm.jpg}
...
You and your friend are arrested, and you both independently talk to the
...
\includegraphics[width=0.45\textwidth,height=\textheight]{media/ch5n/ch5n-10__figure48.png}
...
straightforward (Anderson 1999b; Morel and Ramanujam 1999).
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch5n/image10.jpg}
...
factor (psychopathology factor) is associated with various mental health
problems. {\marginnote{\begin{footnotesize}Common-causes are
...
The study of psychological networks is probably the most thriving area
of complex-systems research in psychology today. This chapter is about
this new line of research. The paper on the mutualism model of general
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch6/fig-ch6-img1-old-70.jpg}
...
Nodes can be anything---particles, neurons, words, people, train
stations, etc. {\marginnote{\begin{footnotesize}A network, a special
type of graph, consists of nodes (often called vertices) and links (or
connections or edges).\end{footnotesize}}} The size of a network is
equal to the number of nodes. Nodes are connected by links. Links can be
directed or undirected. For example, causal links are directed.
Occasionally you see links from the node to itself. In causal networks,
this may represent self-excitation, or if the weight is negative,
self-inhibition. In some cases, links are simply present or absent; in
other cases, links are weighted, as in most neural networks. The matrix
of all weights, indicating the strengths of the connections between
nodes, is called the adjacency or edge matrix. For an undirected
network, the adjacency matrix is symmetric. For a network without
self-loops, the diagonal of the adjacency matrix is 0.
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch6/fig-ch6-img2-old-71.png}
...
\includegraphics[width=0.9\textwidth,height=\textheight]{media/ch6/fig-ch6-img3-old-72.png}
...
states that all people are six or fewer handshakes away from each
other.\footnote{Amazingly, In fact, most people are only four or five
  handshakes away from Napoleon.} For this reason, small-world networks
are useful for studying the spread of information or disease through
social networks.
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch6/fig-ch6-extra-bw.jpeg}
...
test theory and structural equation modeling (SEM). These technically
advanced tools are developed in a field called psychometrics. However,
despite this technical sophistication, it is often not clear what latent
variables are in psychometric models. Some researchers tend to think of
them as purely statistical constructs that help summarize relationships
between variables and make predictions. But more often, either
implicitly or explicitly, latent variables are interpreted as real
constructs, as common causes of observed measures (van Bork et al.
2017). The psychological network approach was developed in response to
the factor approach. The main motivation for the network approach is
that underlying common causes are unsatisfactory if they cannot be
identified independently of the observed relationships they are supposed
to explain (van der Maas et al. 2006). One consequence is that such an
explanation does not provide guidance for possible interventions.
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch6/ch6_4__figure73.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch6/ch6-5__figure74.png}
...
\includegraphics[width=0.75\textwidth,height=\textheight]{media/ch6/fig-ch6-img6-old-75.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch6/fig-ch6-img7-old-76.jpg}
...
updated. {\marginnote{\begin{footnotesize}Cognitive growth is a process
in which new nodes and links are added during
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch6/image8.jpg}
...
figure in the same disorder. (Adapted from Borsboom et al. (2011) with
permission)}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch6/image9.png}
...
\includegraphics[width=0.9\textwidth,height=\textheight]{media/ch6/ch6-11-may31.png}
...
output of the network) or the Hebb rule. With this setup, these models
can explain a number of phenomena in attitude research. Another network
account has been put forward in sociology (DellaPosta 2020).
...
\includegraphics[width=0.6\textwidth,height=\textheight]{media/ch6/ch6-12.png}
...
attended to. Nodes are also influenced by local fields, \(t_{i}\), and a
global external field, \(\tau\). The connections are weighted.}
...
\includegraphics[width=0.6\textwidth,height=\textheight]{media/ch6/ch6-13.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch6/fig-ch6-img12-old-81.jpg}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch6/fig-ch6-img13-old-82.jpg}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch6/fig-ch6-img14-old-83.png}
...
the energy of a particular state. Both functions
(\texttt{glauber\_step()} and \texttt{hamiltonian()}) are added to the R
code.
...
has three stable fixed points for specific combinations of values of
parameters (see section~\ref{sec-Higher-order-catastrophes} and the
exercise about the butterfly catastrophe in that chapter). This is
relevant to the modeling of attitudes because it opens up the
possibility of involved stable in-between attitude positions (see
figure~\ref{fig-ch6-img15-old-84}). The Ising attitude model excludes
this. {\marginnote{\begin{footnotesize}In the Ising attitude model
highly involved persons always radicalize, but more advanced spin models
allow for involved nonpartisan positions.\end{footnotesize}}}
...
have three minima. In the figure \(a = c = 0, d = 5, and b\) varies from
\(1\) to \(-7\).}
...
visualization are igraph and qgraph. Both packages include many useful
functions.
...
\NormalTok{data }\OtherTok{\textless{}{-}} \FunctionTok{run}\NormalTok{(}\AttributeTok{odes =}\NormalTok{ mutualism, }\AttributeTok{tmax =} \DecValTok{1000}\NormalTok{, }\AttributeTok{table =} \ConstantTok{TRUE}\NormalTok{,}
        \AttributeTok{timeplot =}\NormalTok{ (i }\SpecialCharTok{==} \DecValTok{1}\NormalTok{), }\AttributeTok{legend =} \ConstantTok{FALSE}\NormalTok{, }
        \AttributeTok{after =} \StringTok{"state\textless{}{-}state+rnorm(nr\_var,mean=0,sd=1);}
\StringTok{                state[state\textless{}0]=.1"}\NormalTok{)}
...
\NormalTok{fit }\OtherTok{\textless{}{-}} \FunctionTok{graphicalVAR}\NormalTok{(data[}\DecValTok{50}\SpecialCharTok{:}\DecValTok{1000}\NormalTok{,], }\AttributeTok{vars =}\NormalTok{ vars, }\AttributeTok{gamma =} \DecValTok{0}\NormalTok{, }\AttributeTok{nLambda =} \DecValTok{5}\NormalTok{)}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch6/fig-ch6-img16-old-85.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch6/image17.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(}\StringTok{"IsingSampler"}\NormalTok{); }\FunctionTok{library}\NormalTok{(}\StringTok{"IsingFit"}\NormalTok{)}
\FunctionTok{set.seed}\NormalTok{(}\DecValTok{1}\NormalTok{)}
\NormalTok{n }\OtherTok{\textless{}{-}} \DecValTok{8}
\NormalTok{W }\OtherTok{\textless{}{-}} \FunctionTok{matrix}\NormalTok{(}\FunctionTok{runif}\NormalTok{(n}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{, }\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{), n, n); }\CommentTok{\# random positive matrix}
\NormalTok{W }\OtherTok{\textless{}{-}}\NormalTok{ W }\SpecialCharTok{*} \FunctionTok{matrix}\NormalTok{(}\FunctionTok{sample}\NormalTok{(}\DecValTok{0}\SpecialCharTok{:}\DecValTok{1}\NormalTok{, n}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{, }\AttributeTok{prob =} \FunctionTok{c}\NormalTok{(.}\DecValTok{8}\NormalTok{, .}\DecValTok{2}\NormalTok{),}
         \AttributeTok{replace =} \ConstantTok{TRUE}\NormalTok{), n, n) }\CommentTok{\# delete 80\% of nodes}
\NormalTok{W }\OtherTok{\textless{}{-}} \FunctionTok{pmax}\NormalTok{(W, }\FunctionTok{t}\NormalTok{(W)) }\CommentTok{\# make symmetric }
\FunctionTok{diag}\NormalTok{(W) }\OtherTok{\textless{}{-}} \DecValTok{0}
\NormalTok{ndata }\OtherTok{\textless{}{-}} \DecValTok{5000}
\NormalTok{thresholds }\OtherTok{\textless{}{-}} \FunctionTok{rnorm}\NormalTok{(n, }\SpecialCharTok{{-}}\DecValTok{1}\NormalTok{, .}\DecValTok{5}\NormalTok{) }
\NormalTok{data }\OtherTok{\textless{}{-}} \FunctionTok{IsingSampler}\NormalTok{(ndata, W, thresholds, }\AttributeTok{beta =} \DecValTok{1}\NormalTok{)}
...
\FunctionTok{plot}\NormalTok{(thresholds, }\AttributeTok{type =} \StringTok{\textquotesingle{}p\textquotesingle{}}\NormalTok{, }\AttributeTok{bty =} \StringTok{\textquotesingle{}n\textquotesingle{}}\NormalTok{, }\AttributeTok{xlab =} \StringTok{\textquotesingle{}node\textquotesingle{}}\NormalTok{,}
     \AttributeTok{ylab =} \StringTok{\textquotesingle{}Threshold\textquotesingle{}}\NormalTok{, }\AttributeTok{cex =} \DecValTok{2}\NormalTok{, }\AttributeTok{cex.lab =} \FloatTok{1.5}\NormalTok{)}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch6/fig-ch6-img18-old-87.png}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Obama }\OtherTok{\textless{}{-}} \FunctionTok{read.table}\NormalTok{(}\StringTok{"data/Obama.txt"}\NormalTok{, }\AttributeTok{header =} \ConstantTok{TRUE}\NormalTok{) }\CommentTok{\# see book data folder}
\NormalTok{ObamaFit }\OtherTok{\textless{}{-}} \FunctionTok{IsingFit}\NormalTok{(Obama, }\AttributeTok{plot =} \ConstantTok{FALSE}\NormalTok{)}
...
\includegraphics[width=0.9\textwidth,height=\textheight]{media/ch6/fig-ch6-img19-old-88.png}
...
\item
  ...
  check the fit for 1 to 3 factors, and report the \(p\)-values. Fit the
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch7/ch7-1-june14.jpg}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch7/ch7-2-may31.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch7/fig-ch7-img3-old-91.png}
...
\begin{equation}\phantomsection\label{eq-ch7-1-old-50}{
\begin{gathered}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch7/fig-ch7-img4-old-92.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch7/ch7-5__figure95.png}
...
they suddenly shrink to smaller clusters.\end{footnotesize}}} These
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch7/fig-ch7-img6-old-94.jpg}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch7/fig-ch7-img7-old-95.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch7/fig-ch7-img8-old-96-new.png}
...
\includegraphics[width=0.8\textwidth,height=\textheight]{media/ch7/fig-ch7-img9-old-97.png}
...
continuously depends on another continuous variable
(attention).\end{footnotesize}}} In this way, the HIOM bridges these two
modeling traditions.
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch7/image10.png}
...
even more entrenched in their original position. This is due to the
effect of social interaction on attention.\end{footnotesize}}} Without a
cusp for the individual opinion dynamics, this form of polarization
would not occur.
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch7/ch7-11-june14.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch7/ch7-12-june14.png}
...
difficult to study its behavior. One idea is to make attention a network
parameter. An attentive agent simply has many connections to other
agents. As attention decreases, this translates into fewer connections.
...
these systems can be described by a limited number of equilibria. Third,
we can use network science to model complex systems.
...
applicability of chaos theory in studying complexity altogether
(Anderson 1999a).
...
this chapter to introduce main theories in the study of complex systems,
...
as a formalization of these intriguing yet abstract verbal theories. For
instance, the Ising attitude model formalizes of numerous established
...
I expect many more innovations in both network psychology and network
psychometrics.
...
rapidly evolving field. Finding the right balance in simplification has
...
cusps, and the HIOM, where cusp-like agents interact within social
...
my exercises will encourage your engagement in formal modeling in
psychology.
...
\bibitem[\citeproctext]{ref-adamsEffectOrientationReversal1959}
