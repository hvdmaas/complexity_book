...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[enhanced, breakable, boxrule=0pt, sharp corners, frame hidden, colback={codebgcolor}]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
...
\includegraphics{media/ch1/ch1-3-june14.png}
...
\includegraphics[width=1\textwidth,height=\textheight]{media/ch4n/ch4n-4__figure53.png}
