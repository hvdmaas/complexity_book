...
\makeatother
\makeatletter
\ifdefined\Shaded\renewenvironment{Shaded}{\begin{tcolorbox}[sharp corners, colback={codebgcolor}, enhanced, breakable, frame hidden, boxrule=0pt]}{\end{tcolorbox}}\fi
\makeatother
\makeatletter
