...
![Exponential growth.](media/ch2/fig-ch2-img1.jpg){#fig-ch2-img1 width="10cm"}

![Exponential growth.](media/ch2/fig-ch2-img1.jpg){width="8cm"}
...
![The $r=2$ case.](media/ch2/fig-ch2-img2.jpg){#fig-ch2-img2 width="10cm"}

![The $r=2$ case.](media/ch2/fig-ch2-img2.jpg){width="8cm"}
...
![Qualitative different behavior of the logistic map for different values of $r$.](media/ch2/fig-ch2-img4.jpg){#fig-ch2-img4 width="14cm"}

For $r = 2.9$ we see that the series converges to the fixed point $\frac{1.9}{2.9} = .66,$ but in a process of over- and undershooting. Between $r = 3.1$ and $r = 3.3$ a limit cycle of period 2 arises. [In a limit cycle of period 2 the population oscillates between two values.]{.aside} For $r = 3.5$ this becomes even more remarkable, we see a limit cycle of period 4. For slightly larger values we could get cycles with higher periods.
...
![Time (top) and phase (bottom) plots for three cases. Chaos and random noise can be distinguished using the phase plots.](media/ch2/fig-ch2-img7.jpg){#fig-ch2-img7 width="14cm"}
...
![The bifurcation diagram of the logistic map.](media/ch2/fig-ch2-img8.jpg){#fig-ch2-img8 width="14cm"}

A recurring phenomenon in many chaotic maps are fractals. [Fractals are figures in which certain patterns reappear when we zoom in on the figure, and this happens again and again when we zoom in further.]{.aside} You can see the fractal nature of the logistic map by zooming in on the interval of r between 3.83 and 3.86 (see exercise 2). The three equilibria in the limit cycle split again into period doubling cycles, as we saw in the overall plot between $r$ in 3 and 3.5.
