...
![Exponential growth.](media/ch2/fig-ch2-img1.jpg){#fig-ch2-img1}
...
![The $r=2$ case.](media/ch2/fig-ch2-img2.jpg){#fig-ch2-img2}
...
![Illustration of stable and unstable fixed points. For many initial values, $X = .5$ is an attractor. $X = 0$ is an unstable fixed point. Only if we start exactly at 0 do we stay there.](media/ch2/fig-ch2-img3.jpg){#fig-ch2-img3}
...
![Qualitative different behavior of the logistic map for different values of $r$.](media/ch2/fig-ch2-img4.jpg){#fig-ch2-img4}
...
![Chaos for $r = 4$.](media/ch2/fig-ch2-img5.jpg){#fig-ch2-img5}
...
![The butterfly effect: A small difference in initial state causes divergence in the long run.](media/ch2/fig-ch2-img6.jpg){#fig-ch2-img6}
...
![Time (top) and phase (bottom) plots for three cases. Chaos and random noise can be distinguished using the phase plots.](media/ch2/fig-ch2-img7.jpg){#fig-ch2-img7}
...
![The bifurcation diagram of the logistic map.](media/ch2/fig-ch2-img8.jpg){#fig-ch2-img8}
