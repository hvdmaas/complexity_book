...
[ask]{.blue} [turtles with]{.purple} [\[</span>]{.text}[pcolor =]{.purple} [red]{.val} <span class="text">\] [set]{.blue} [pcolor]{.purple} [green]{.val}
