...
![Schematic picture of the magnet](media/exch4/image1.jpg){#fig-exch4-img1-old-39 width="400"}

The main model equations of the Ising model are:

$$
H\left( \mathbf{x} \right) = - \sum_{i}^{n}{\tau x_{i}} - \sum_{< i,j >}^{}{x_{i}x_{j}}$$ {#eq-exch4-1-old-17}

$$
P\left( \mathbf{X} = \mathbf{x} \right) = \frac{\exp\left( - \beta H\left( \mathbf{x} \right) \right)}{Z}.$$ {#eq-exch4-2-old-18}
...
$$
P\left( x_{i} \rightarrow - x_{i} \right) = \frac{1}{\left( 1 + e^{- \beta\left( H\left( x_{i} \right) - H\left( - x_{i} \right) \right)} \right)}.$$ {#eq-exch4-3-old-19}
...
![An example of the ant bridge.](media/ch4/image2.jpg){#fig-exch4-img2-old-40}
...
![The rules of the Game of Life.](media/ch4/image3.jpg){#fig-exch4-img3-old-41}
...
![The Turing Machine built in the Game of Life.](media/ch4/image4.jpg){#fig-exch4-img4-old-42}
...
![The deep learning restricted Boltzmann machine.](media/ch4/image5.jpg){#fig-exch4-img5-old-43}
...
![The 'Kindergarten' Illusion from The Optical Illusion model in NetLogo.](media/ch4/image6.jpg){#fig-exch4-img6-old-44}
...
$$
V(\varphi) = - \Delta w\varphi - b\cos\varphi - a\cos{2\varphi}$$ {#eq-exch4-4-old-20}
...
![Beach Beast \| www.strandbeest.com/ IMG_4285.jpg \| Robbert van den Beld \| Flickr](media/ch4/image8.jpg){#fig-exch4-img8-old-46}
...
![The prisoner's dilemma.](media/ch4/image9.jpg){#fig-exch4-img9-old-47}
...
![Team assembly model. Newcomers and incumbents are added to growing networks based on probabilities p and q. If p is sufficiently high, a dense network emerges.](media/ch4/image10.jpg){#fig-exch4-img10-old-48}
