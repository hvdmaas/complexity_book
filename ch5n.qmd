...
## Introduction {#sec-Introduction-ch5n}

We saw chaos and phase transitions in Chapters 2 and 3 and will now focus on a third amazing property: self-organization. [Self-organization is captivating because it reveals the remarkable ability of complex systems to generate order and structure without external control or intervention.]{.aside} Self-organization plays an essential role in psychological and social processes. It operates in our neural system at the neuronal level, in perceptual processes as well in higher cognition. In human interactions, self-organization is a key mechanism in cooperation and opinion polarization.
...
![The Turing machine built in the Game of Life. (Reproduced from LifeWiki.)](media/ch5n/image4.jpg){#fig-ch5n-img4-old-42 width="100%"}
...
![The Kindergarten illusion from The Optical Illusion model in NetLogo.](media/ch5n/ch5n-6.png){#fig-ch5n-img6-old-44 width="60%"}
