...
![Schematic picture of the magnet. Spins, $x$, can be left ($1$) or right ($-1$). At lower temperatures, $T$, the spins tend to align with neighboring spins and the external field, $\tau$, resulting in magnetism.](media/ch5n/ch5n-1-Han.png){#fig-ch5n-img1-old-39}
...
![The ant bridge is an example of collective behavior.](media/ch5n/image2b.jpeg){#fig-ch5n-img2-old-40}
...
![The rules of the Game of Life.](media/ch5n/ch5n-3.png){#fig-ch5n-img3-old-41}
...
![The Turing machine built in the Game of Life.](media/ch5n/image4.jpg){#fig-ch5n-img4-old-42 width="14cm"}
...
![The deep learning restricted Boltzmann machine.](media/ch5n/ch5n-5__figure43.png){#fig-ch5n-img5-old-43}
...
![The Kindergarten illusion from The Optical Illusion model in NetLogo.](media/ch5n/ch5n-6.png){#fig-ch5n-img6-old-44}
...
![Beach Beast © Theo Jansen, Umerus 2009, c/o Pictoright Amsterdam 2024](media/ch5n/strandbeest_Han_perm.jpg){#fig-ch5n-img8-old-46}
...
![The prisoner's dilemma. If both A and B remain silent, they each face a two-year sentence. If one talks and the other does not, the informer is released and the silent partner gets a decade behind bars. If both betray, they serve five years.](media/ch5n/ch5n-10__figure48.png){#fig-ch5n-img9-old-47}
...
![Team assembly model. Newcomers and incumbents are added to growing networks based on probabilities p and q. If p is sufficiently high, a dense network emerges. (Adapted from @guimeraTeamAssemblyMechanisms2005 with permission)](media/ch5n/image10.jpg){#fig-ch5n-img10-old-48 width="454"}
