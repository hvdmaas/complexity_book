...
![Schematic picture of the magnet. Spins can be up or down. At lower temperatures, the spins tend to align with neighboring spins and the external field, resulting in magnetism.](media/ch5n/image1.jpg){#fig-ch5n-img1-old-39 width="4.7cm"}
...
![The rules of the Game of Life.](media/ch5n/image3.jpg){#fig-ch5n-img3-old-41}
...
![The Turing machine built in the Game of Life.](media/ch5n/image4.jpg){#fig-ch5n-img4-old-42 width="12cm"}
...
![The deep learning restricted Boltzmann machine.](media/ch5n/image5.jpg){#fig-ch5n-img5-old-43 width="13cm"}
...
![The Kindergarten illusion from The Optical Illusion model in NetLogo.](media/ch5n/image6.jpg){#fig-ch5n-img6-old-44 width="9cm"}
...
![Beach Beast \| www.strandbeest.com/ **IMG_4285.jpg \| Robbert van den Beld \| Flickr**](media/ch5n/image8b.png){#fig-ch5n-img8-old-46 width="13cm"}
...
In the late twentieth century, developmental theories inspired by work in embodied cognition, nonlinear dynamics, synergetics, and neural networks (e.g., Edelman's neural Darwinism) became popular. Embodied cognition is the theory that an individual's understanding and thinking are intricately connected to the body's interactions with the environment, suggesting that cognitive processes are shaped by the body's actions and sensory experiences. A key example is Esther Thelen's work on the development of walking and reaching [@thelenMotorDevelopmentNew1995]. Another famous Piagetian task, the A-not-B error, plays a central role in this. The A-not-B error typically occurs in a simple game where an adult hides an object in a known location (A) in front of an infant several times. After a few trials, the adult hides the object in a new location (B) while the infant is watching. Despite watching the object being hidden in the new location, infants tend to continue searching for the object in the old location (A).
...
A simple but famous example of social self-organization concerns pedestrian dynamics as studied by @helbingSocialForceModel1995. They proposed a physics-based model for panic evacuation. For an excellent overview of crowd simulation, I again refer to Wikipedia. Some of this work is rooted in the social sciences. An example in NetLogo is the model "Path."
...
![The prisoner's dilemma. If both A and B remain silent, they each face a two-year sentence. If one talks and the other does not, the informer is released and the silent partner gets a decade behind bars. If both betray, they serve five years.](media/ch5n/image9.jpg){#fig-ch5n-img9-old-47 width="8cm"}
...
![Team assembly model. Newcomers and incumbents are added to growing networks based on probabilities p and q. If p is sufficiently high, a dense network emerges.](media/ch5n/image10.jpg){#fig-ch5n-img10-old-48 width="12cm"}
