...
4)  Some insight into the butterfly catastrophe $V(X) = {- aX - bX^{2} - cX}^{3} - dX^{4} + X^{6}$ can be gained by entering the equation in the online graphing calculator GeoGebra. Set a, b, c, d to 0, -5, 0, 5. Then start varying a and c. What is the difference in the effect of these two parameters on the attractors? (\*)
...
9)  Find a paper on chaos detection in psychology or psychophysiology and summarize it in 300-400 words (\*\*)
