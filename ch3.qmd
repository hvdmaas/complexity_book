...
![A first order (discontinuous) and second order (continuous) phase transition (from: <https://polymerdatabase.com/polymer%20physics/ThemalTransitions.html>).](media/ch3/ch3-01__figure13.png){#fig-ch3-img1-old-13}
...
![The bifurcation diagram of the Spruce Budworm model (Copied from Modeling the Spruce Budworm, Jacai deNeveu, 2015).](media/ch3/ch3-16__figure28.png){#fig-ch3-img16-old-28}
...
![At the back of the cusp (low $b0$), the cusp is approximately linear and cuspfit prefers this simpler model (red line) over the cusp mode (blue line).](media/ch3/fig-ch3-img23-old-35.jpg){#fig-ch3-img23-old-35}
