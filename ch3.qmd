...
![The quadratic potential function. **A boll rolls to the minimum value of** $V(X)$**. It's change is defined by negative of the derivative,** $-V'(X)$, **of the potential function.**](media/ch3/image3.jpg){#fig-ch3-img3-old-15 width="2.695424321959755in" height="1.917276902887139in"}
...
To explain catastrophic drops in performance in work and sports, @hardy1991 developed a cusp model with cognitive anxiety as the splitting factor and physiological arousal as the normal factor.
