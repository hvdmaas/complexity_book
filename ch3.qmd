...
![A first order (discontinuous) and second order (continuous) phase transition. (from: <https://polymerdatabase.com/polymer%20physics/ThemalTransitions.html>)](media/ch3/image1.jpg){#fig-ch3-img1-old-13 width="5.174305555555556in" height="2.4652777777777777in"}

Discontinuous phase transitions such as melting and freezing occur in many systems. Famous examples from the natural sciences include collapsing bridges, turning over ships, cell division, and climate transitions such as the onset of ice ages.

Examples from the social sciences include conflict, war, and revolution. Some examples from psychology are falling asleep, outbursts of aggression, radicalization, falling in love, sudden insights, relapses into depression or addiction, panic, and multistable perception. **Building and testing models of these psychological transitions is challenging but rewarding. These transitions represent significant changes, in contrast to the smaller, often marginally significant effects typically observed in psychological intervention studies. During these transitions, there is a profound change in psychological systems.**

![Transitions in the perception of the Necker cube. The perception of the middle cube is bistable, and sudden transitions occur between the left ('front') and right ('back') percepts. Multistable perception is a much studied psychological phenomenon that is still not fully understood.](media/ch3/image2.jpg){#fig-ch3-img2-old-14 width="3.6770024059492563in" height="1.2100339020122484in"}
...
![The quadratic potential function. **A boll rolls to the minimum value of** $V(X)$**. It's change is defined by the derivative of the potential function.**](media/ch3/image3.jpg){#fig-ch3-img3-old-15 width="2.695424321959755in" height="1.917276902887139in"}
...
![A bifurcation at $a = 0$: the equilibria change qualitatively. **For** $a<0$ **there is no equilibrium, for** $a>0$ **we have a minimum and a maximum.**](media/ch3/image4.jpg){#fig-ch3-img4-old-16 width="3.985962379702537in" height="2.6466786964129483in"}
...
![The bifurcation diagram of the fold catastrophe. Similar to what's shown in the preceding figure, when $a=0$, there is a dramatic alteration in the equilibrium landscape. Suddenly, both a stable and an unstable equilibrium emerge, seemingly from nowhere.](media/ch3/image5.jpg){#fig-ch3-img5-old-17 width="4.277777777777778in" height="2.6805555555555554in"}
...
![The fold in drawings [from, @mcrobieSeductionCurvesLines2017]. **The fold line separates the parts that can be seen from the parts that are hidden.**](media/ch3/image6.jpg){#fig-ch3-img6-old-18 width="2.540321522309711in" height="3.640939413823272in"}
...
![The change in the potential function of the cusp by varying $a$. **Note that the jump to the other state does not happen at** $a=0$ **but is delayed and depends on the direction of the change in** $a$**. This delay is called hysteresis.**](media/ch3/image7.jpg){#fig-ch3-img7-old-19 width="6.263888888888889in" height="1.3263888888888888in"}
...
![The change in the potential function of the cusp by varying $b$. **One minimum splits up in two.**](media/ch3/image8.jpg){#fig-ch3-img8-old-20 width="6.263888888888889in" height="1.3243055555555556in"}
...
![Bifurcation diagrams along the $a$ and $b$ axes. The area in the dotted box is a fold.](media/ch3/image9.jpg){#fig-ch3-img9-old-21 width="6.263888888888889in" height="2.1180555555555554in"}
...
This type of equation is called a cubic equation.[^ch3-2] The degenerate critical points of the cusp can be found by setting the first and second derivative to zero. This is just within reach of your high school mathematics training and I leave this as an exercise. The result is:

[^ch3-2]: The cubic equation that cannot solved easily. This is due to the fact that the cusp is not a function of the form $y = f(x)$. Functions assign to each element of $x$ exactly one element of $y$. But in bistable systems we assign two values of $y$ to one value of $x$.
...
![A simple business card can be used to illustrate all the properties of the cusp (see text).](media/ch3/image11.jpg){#fig-ch3-img11-old-23 width="2.467130358705162in" height="2.429932195975503in"}
...
<!---![The phase diagram of water, which summarizes the equilibria and transitions in the state of water as a function of temperature and pressure.](media/ch3/image12.jpg){#fig-ch3-img12-old-24 width="0.2in" height="0.2in"}--->
...
![The cusp model of attitudes (toward abortion). Because of hysteresis, it is very difficult to persuade highly involved people with new information, but if they change it will be a sudden jump.](media/ch3/image13.jpg){#fig-ch3-img13-old-25 width="3.1271905074365702in" height="2.783963254593176in"}

Cusp modeling begins by the definition of the states of the behavioral variable. In this case the two states of the bistable cusp are the two opposing positions, pro-life[^ch3-3] and pro-choice. The other state associated with $a = 0, b = 0$ is the neutral state, an 'I don't know' or 'I don't care' position.

[^ch3-3]: Perhaps better to call this view anti-choice
...
![From @stewartCatastropheTheoryModeling1983. The fitted bifurcation lines were calculated using Cobb's method, which is explained in section 3.3.3.](media/ch3/image14.jpg){#fig-ch3-img14-old-26 width="3.718439413823272in" height="2.6569116360454945in"}
...
![Perturbed pitchfork bifurcation ($a = .1$). For $a = 0$ we would get the pitchfork bifurcation as shown in @fig-ch3-img9-old-21. Thus, a perturbation in a model parameter leads to qualitative change in this bifurcation, and this is the reason why it is not considered structurally stable.](media/ch3/image15.jpg){#fig-ch3-img15-old-27 width="3.8476957567804027in" height="2.471142825896763in"}
...
![@zeemanCatastropheTheory1976 dog aggression model with rage and fear as rotated control variables.](media/ch3/image17.jpg){#fig-ch3-img17-old-29 width="2.530972222222222in"}
...
There are many other examples of phenomenological cusp model in psychology. For example, cusp models have been proposed for addiction [@guastelloCuspButterflyCatastrophe1984; @mazanovCuspCatastropheModel2006; @witkiewitzNonnormalityDivergencePosttreatment2007], for performance in work and sports [@cohenCriticalElaborationEmpirical2003; @guastelloCuspCatastropheModels2019; @hardyTestingPredictionsCusp1996] and for humor [@paulosMathematicsHumor2008].[^ch3-4]

[^ch3-4]: Given these guidelines and examples it is an interesting exercise to develop one's own cusp model, for example, for falling in love. This is a tricky exercise.
...
![Continuous and discontinuous growth curves my look very similar.](media/ch3/image18.jpg){#fig-ch3-img18-old-30 width="3.126003937007874in" height="1.6610793963254593in"}
...
![A sudden jump to depression (score at the SLC-90) in a patient who gradually quitted antidepressant medication during the study.](media/ch3/image19.jpg){#fig-ch3-img19-old-31 width="3.9362904636920386in"}
...
![Bimodality in the expected heights of water when it is poured into a wider glass. This variation of the Piagetian maintenance task is used with children ages 5-8.](media/ch3/image20.jpg){#fig-ch3-img20-old-32 width="3.9893274278215225in"}
...
![The pitchfork bifurcation in attitudes. The dotted lines represent the fit of the cusp model to these data. This technique will be discussed in the final section in this chapter.](media/ch3/image21.jpg){#fig-ch3-img21-old-33 width="4.123746719160105in" height="2.1345647419072615in"}

#### Hysteresis

Hysteresis, **the lagging behind of the sudden jump,** requires sophisticated manipulation of the normal control variable. We need to slowly increase and decrease this variable and test whether sudden jumps occur with a delay. We have demonstrated hysteresis with some success for proportional reasoning [@jansenEvidencePhaseTransition2001], for the speed-accuracy trade-off [@dutilhPhaseTransitionModel2011], and for multistable perception [@ploegerStochasticCatastropheAnalysis2002].
...
The basic idea is to make catastrophe theory, a deterministic theory, stochastic by adding a stochastic term, called Wiener noise (with variance $\sigma^{2})$, to @eq-ch3-2-old-6[^ch3-5]:

[^ch3-5]: Many different t notations exist for his. Perhaps clearer is $dX(t) = - V^{'}\left( X(t) \right)dt + \sigma dW(t)$, as $dX$ and \$ dW\\ \$ depend on time.
...
where Z is a normalizing constant[^ch3-6] necessary to ensure that the area under $f(X)$ is 1. This may look complicated but for the quadratic case $V(X) = {\frac{1}{2}X}^{2}$, this results in the standard normal distribution, with $Z = \frac{\sqrt{2\pi}}{\sigma}$.

[^ch3-6]: For consistency with later chapters, I define $Z$ differently from the notation in [@grasmanFittingCuspCatastrophe2009]. It is the inverse of $Z$ in that paper.
...
![At the back of the cusp (low $b0$), the cusp is approximately linear and cuspfit prefers this simpler model over the cusp model.](media/ch3/image23.jpg){#fig-ch3-img23-old-35 width="4.825188101487314in" height="3.0759241032370954in"}
...
![Placement of the data of @fig-ch3-img21-old-33 in the bifurcation set.](media/ch3/image24.jpg){#fig-ch3-img24-old-36 width="3.8184055118110236in" height="2.8261286089238844in"}
...
![The fit of Bentler conservation data.](media/ch3/image25.jpg){#fig-ch3-img25-old-37 width="4.5743646106736655in" height="4.304061679790026in"}
...
One often speaks of the rise and the fall of catastrophe theory [@rosserRiseFallCatastrophe2007]. The hype following Zeeman's famous Scientific American paper[^ch3-7] [@zeemanCatastropheTheory1976], **in which he introduced the phenomenological application of catastrophe theory in the behavioral and social sciences,** led to a strongly worded reply by @zahlerClaimsAccomplishmentsApplied1977 in Nature.

[^ch3-7]: I recommend the BBC documentary "Case Study Catastrophe Theory Maths Foundation Course"
...
**Psychologists are concerned with types and classes, stages and phases, and the transitions between them. Our thinking about transitions becomes much clearer and more advanced when we know the basics of catastrophe and bifurcation theory. Catastrophe theory also comes with a toolbox. We can build phenomenological models, test for catastrophe flags, and even fit cusp models to data. With the development of this toolbox, most of the criticisms of catastrophe theory lose their relevance. But there are opportunities for further improvements. Phenomenological models have limited explanatory power. As we will see in later chapters, it is possible to create more mechanistic models that support the use of phenomenological models. In Chapter 6, I will discuss the Ising network model for attitudes, the behavior of which is governed by the cusp model I introduced for attitudes toward abortion. Cobb's method applies only to cross-sectional data. A simple approach for time series data would be very useful.**
