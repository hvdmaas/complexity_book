...
![The fold in drawings [from, @mcrobieSeductionCurvesLines2017]. The fold line separates the parts that can be seen from the parts that are hidden. For seductive curves of excessive masculine figures, I refer to McRobie's book.](media/ch3/image6.png){#fig-ch3-img6-old-18 width="12cm"}
