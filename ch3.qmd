...
![Transitions in the perception of the Necker cube. The perception of the middle cube is bistable, and sudden transitions occur between the left ('front') and right ('back') percepts.](media/ch3/image2.jpg){#fig-ch3-img2-old-14 width="3.6770024059492563in" height="1.2100339020122484in"}
...
![The quadratic potential function](media/ch3/image3.jpg){#fig-ch3-img3-old-15 width="2.695424321959755in" height="1.917276902887139in"}
...
![A bifurcation at $a = 0$: the equilibria change in qualitative way.](media/ch3/image4.jpg){#fig-ch3-img4-old-16 width="3.985962379702537in" height="2.6466786964129483in"}
...
![The bifurcation diagram of the fold catastrophe](media/ch3/image5.jpg){#fig-ch3-img5-old-17 width="4.277777777777778in" height="2.6805555555555554in"}
...
The basic idea is to make catastrophe theory, a deterministic theory, stochastic by adding a stochastic term, called Wiener noise (with variance $\sigma^{2})$, to @eq-ch3-2-old-6[^ch3-4]:
