...
![Relations between the main evidence accumulator models of decision making. DDM is the drift diffusion model which can be derived from the mutual inhibition model by setting $w = k$ and $w + k$ to a large value. **Adapted from @bogaczPhysicsOptimalDecision2006.**](media/ch5/image8.jpg){#fig-ch5-img8-old-56 width="3.8890234033245843in"}
