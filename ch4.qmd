...
![Schematic picture of the magnet](media/ch4/image1.jpg){#fig-ch4-img1-old-39}

The main model equations of the Ising model are:

$$
H\left( \mathbf{x} \right) = - \sum_{i}^{n}{\tau x_{i}} - \sum_{< i,j >}^{}{x_{i}x_{j}}$$ {#eq-ch4-1-old-17}

$$
P\left( \mathbf{X} = \mathbf{x} \right) = \frac{\exp\left( - \beta H\left( \mathbf{x} \right) \right)}{Z}.$$ {#eq-ch4-2-old-18}
...
$$
P\left( x_{i} \rightarrow - x_{i} \right) = \frac{1}{\left( 1 + e^{- \beta\left( H\left( x_{i} \right) - H\left( - x_{i} \right) \right)} \right)}.$$ {#eq-ch4-3-old-19}
...
In the 2D Ising model (see @fig-ch4-img1-old-39), the connections are sparse (only local) and more complicated (self-organizing) behavior occurs. We will simulate this in NetLogo later in this chapter and as a model of attitudes in chapter 6.
...
![An example of the ant bridge](media/ch4/image2.jpg){#fig-ch4-img2-old-40}
...
Another crucially important area of research on self-organisation has been computer science. A simple but utterly amazing example is the work on Conways' game of life [@berlekampWinningWaysYour2004]. The rules are depicted in @fig-ch4-img3-old-41.

![The rules of the Game of Life](media/ch4/image3.jpg){#fig-ch4-img3-old-41}
...
![The Turing Machine built in the Game of Life.](media/ch4/image4.jpg){#fig-ch4-img4-old-42"}
...
![The deep learning restricted Boltzmann machine.](media/ch4/image5.jpg){#fig-ch4-img5-old-43}
...
<span class="blue"> ask </span> <span class="purple">turtles with</span> <span class="text">[</span> <span class="purple">pcolor = </span> <span class="val">red</span> <span class="text">]</span> <span class="blue">set</span> <span class="purple">pcolor</span> <span class="val">green</span>
...
<span class="green">to</span> <span class="text">setup</span> <br> &nbsp;&nbsp;&nbsp;&nbsp; <span class="purple">clear-all</span> <br> &nbsp;&nbsp;&nbsp;&nbsp; <span class="purple">reset-clicks</span> <br> <span class="green">end</span>

<span class="green">to</span> <span class="text">go</span> <br> &nbsp;&nbsp;&nbsp;&nbsp; <span class="purple">tick</span> <br> <span class="green">end</span>
...
<span class="blue">ask</span> <span class="purple">patches</span> <br> <span class="text">[</span> <span class="blue">set</span> <span class="purple">pcolor one-of</span> <span class="text">[</span> <span class="val">white blue</span> <span class="text">]]</span> <span class="comm">; white is dead, blue is alive</span>
...
<span class="green">patches-own</span> <span class="text">[new-state]</span>

In the 'go' function, we add the life rules.

<span class="blue">ask</span> <span class="purple">patches</span> <span class="text">]</span> <br> &nbsp;&nbsp;&nbsp;&nbsp; <span class="blue">if</span> <span class="text">(</span> <span class="purple">neighbors with</span> <span class="text">[</span> <span class="purple">pcolor =</span> <span class="val">blue</span> <span class="text">])</span> <span class="purple">></span> <span class="val">3</span> <span class="text">)</span> <span class="text">[</span> <span class="blue">set</span> <span class="text">new-state</span> <span class="val">white</span> <span class="text">]</span> <br> &nbsp;&nbsp;&nbsp;&nbsp; <span class="blue">if</span> <span class="text">(</span> <span class="purple">neighbors with</span> <span class="text">[</span> <span class="purple">pcolor =</span> <span class="val">blue</span> <span class="text">])</span> <span class="purple"><</span> <span class="val">2</span> <span class="text">)</span> <span class="text">[</span> <span class="blue">set</span> <span class="text">new-state</span> <span class="val">white</span> <span class="text">]</span> <br> &nbsp;&nbsp;&nbsp;&nbsp; <span class="blue">if</span> <span class="text">(</span> <span class="purple">neighbors with</span> <span class="text">[</span> <span class="purple">pcolor =</span> <span class="val">blue</span> <span class="text">])</span> <span class="purple">=</span> <span class="val">3</span> <span class="text">)</span> <span class="text">[</span> <span class="blue">set</span> <span class="text">new-state</span> <span class="val">blue</span> <span class="text">]</span> <br> <span class="text">]</span>

<span class="blue">ask</span> <span class="purple">patches</span> <span class="text">[</span> <span class="blue">set</span> <span class="purple">pcolor</span> <span class="text">new-state</span> <span class="text">]</span>
...
<span class="blue">let</span> <span class="val">0.001</span> <span class="purple">\*</span> <span class="text">Ediff</span> <span class="val">2</span> <span class="purple">\*</span> <span class="text">spin</span> <span class="purple">* sum</span> <span class="text">[ spin ]</span> <span class="purple">of patches</span>
...
![The 'Kindergarten' Illusion from The Optical Illusion model in NetLogo.](media/ch4/image6.jpg){#fig-ch4-img6-old-44}
...
$$
V(\varphi) = - \Delta w\varphi - b\cos\varphi - a\cos{2\varphi}$$ {#eq-ch4-4-old-20}
...
![Beach Beast \| www.strandbeest.com/ IMG_4285.jpg \| Robbert van den Beld \| Flickr](media/ch4/image8.jpg){#fig-ch4-img8-old-46}
...
![The prisoner's dilemma.](media/ch4/image9.jpg){#fig-ch4-img9-old-47}
...
![Team assembly model. Newcomers and incumbents are added to growing networks based on probabilities p and q. If p is sufficiently high, a dense network emerges.](media/ch4/image10.jpg){#fig-ch4-img10-old-48}
