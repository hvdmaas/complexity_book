...
[ask]{.blue} [patches]{.purple} <br> [\[</span> ]{.text}[set]{.blue} [pcolor one-of]{.purple} <span class="text">\[</span> [white blue]{.val} <span class="text">\]\] [; white is dead, blue is alive]{.comm}
