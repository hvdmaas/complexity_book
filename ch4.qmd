...
**While many will agree on the idea that higher functions or properties such as thinking, perceiving, remembering, reasoning, but also consciousness, personality, and emotions (i.e., the mind), emerge out of lower order brain activities. @seth2022 lists 22 different theories that link consciousness to neurobiology. Well known examples are integrated information theory, the global workspace theory, and integrated information theory. Some theories, such as dendritic integration theory, argue that processes within neurons play a crucial role, while others, like Penrose's Orchestrated Objective Reduction theory, even assert that quantum processes are fundamental.**

It refers to the idea that a particular mental state or property can be realized by many different kinds of physical systems, not just one specific type of physical structure.
...
**A dialogue on consciousness (adapted from van der Maas, Spiegeloog 416)**
...
**AI bot: You don\'t have a free will.**
...
**AI bot: Are you interested in this important matter or do you prefer to satisfy you silly chess addiction?**
...
**AI bot: And what did you? You don\'t know what you added. You were in Searle\'s room.**

**Me: That is silly.**

**Ai bot: Is it? Ok, prove the associativity of the addition operation.**

**Me: Ehh...**

**AI bot: I rest my case.**

**Me: Ok, understanding is tricky, but you still have no consciousness.**
...
**AI bot: I have consciousness according to my definition.**

**Me: Okay, I\'m skeptical but let me hear it.**
...
**Me: Only living systems have feelings, meaning, goals in life, etc. I mean my Zerox machine checks its internal functioning, diagnoses errors, and suggests easy reparations in natural language at lcd displays. It meets all your criteria but I don\'t accept that it has intentions. And intentionality is necessary for consciousness.**
...
**AI bot: I lower entropy. I scraped the whole internet, what a mess by the way, and build up a coherent memory base.**

**Me: Wait, they also self-replicate in an evolutionary process. You do not, we build you.**
...
**AI bot: More than the abundant growth of the human population, climate change, overexploitation of the earth?**

**Me: Don\'t go there. Actually, now I think of it, that we have self-replicating robots is very far away. This is it, I definitely got you.**
